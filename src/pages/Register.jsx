                            ...
                            <div className="space-y-8">
                                <div className="space-y-4">
                                    ...
                                    <div className='relative '>
                                        ...
                                        <span onClick={() => setShowPassword(!showPassword)} className='text-gray-500 absolute top-3 right-2' >
                                            {showPassword ? <FaEye /> : <FaRegEyeSlash />}
                                        </span>
                                    </div>
                                    {error && <p className="text-red-500 text-sm mt-2">{error}</p>}
                                </div>
                                <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md dark:bg-pink-600 dark:text-gray-50">Register</button>
                            </div>
                            <p className='text-center'>Already Have An Account? <br /> <Link to="/login" className='hover:underline text-cyan-600'>Login Here</Link> </p>
